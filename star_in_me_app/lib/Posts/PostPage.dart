...
List<PostModel> posts = [
  PostModel(
      ...
      "This is the description which user provides for given post. this may be a bit longer as well",
      null,
      null,
      null,
      null,
                    ...
                    child: Row(
                      children: [
                        ...
                        CircleAvatar(
                          ...
                          child: ClipOval(
                            child:
                                Image.asset("images/UI1.png", fit: BoxFit.fill),
                          ),
                        ),
                        SizedBox(width: 20),
                        Expanded(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    PostModel sharedpost = await Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SharePost(post)));
                    if (sharedpost != null) posts.insert(0, sharedpost);
        ...
        child: Column(
          children: [
            ...
            Padding(
              padding: EdgeInsets.all(20),
              child: Text(
                  "Choose a reason for reporting this post. Help us understand what's wrong with the post"),
            ),
            Column(
  ...
  Widget ReportTile(String data) {
    return ListTile(
        ...
        trailing: IconButton(
          ...
          icon: (selected[report.indexOf(data)])
              ? Icon(
                  Icons.check_box,
                  color: Colors.deepPurple,
                )
              ...
              trailing: Wrap(
                children: <Widget>[
                  FlatButton(
                    ...
                    color: Colors.deepPurple,
                    onPressed: () {
                      PostModel sharedpost = PostModel(
                          controller.text + '\n' + post.title,
                          post.description,
                          post.media,
                          post.location,
