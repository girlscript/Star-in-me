                      ...
                      child: ButtonTheme(
                           ...
                           padding: EdgeInsets.only(left:5.0,right:5.0),                 
                            ...
                            children:<Widget>[
                              ...
                              child: Image.asset('images/linkedin_logo.png',height: 40.0,width: 15.0,),),
       ...
       catchError: (LinkedInErrorObject error) {
         print(
             ...
             ' Error code: ${error.statusCode.toString()}');
                    ...
                    Expanded(
                      child: ButtonTheme(
                          ...
                          padding: EdgeInsets.only(left:5.0,right:5.0),
                            ...
                            children:<Widget>[
                              Padding(padding:const EdgeInsets.only(left:5.0,right:5.0),
                              child: Image.asset('images/google_logo.png',height: 40.0,width: 10.0,),),
                          ...
                          onPressed: () async{
                                                    ...
                                                    try {
                                  final user= await _signUpWithGoogle();
                ...
                TextFormField(
                            ...
                            Padding(
                              ...
                              child: Row(
            children:<Widget>[
              Text('By signing up, I agree to the ',style: TextStyle(
                color: Colors.grey,
          ...
          Padding(
            ...
            child: Row(
              children:<Widget>[
                Text('Already have an account on ',style: TextStyle(color:Colors.grey),),
                Text('The Star in me? ',style: TextStyle(color:Colors.purple[300],fontWeight: FontWeight.bold),),
                Material(
                  color: Colors.white.withOpacity(0.0),
                  child: InkWell(
                    child:Text('Log in',style:TextStyle(color:Colors.purple[700])),
